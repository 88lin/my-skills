...
Brand: use a font direction that reflects the brand lane (display serif + sans body for editorial/luxury, one committed sans for tech, etc.). Prefer fluid `clamp()` scale for display typography and a hierarchy ratio of at least 1.25 between steps.
