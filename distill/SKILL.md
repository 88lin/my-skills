...
If any of these are unclear from the codebase, STOP and use the structured user-input/question tool when available; if unavailable, ask directly in chat to clarify what you cannot infer.
