...
- Building a multi-component HTML artifact with React
- Building an artifact with routing, state management, or shadcn/ui dependencies
- Building something closer to an interactive demo, mini-app, or structured artifact system than a normal page

Do **not** use this by default in these cases:

- Normal pages or app UI: prefer `frontend-design`
